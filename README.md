...
End users interact with a simplified interface: starting from the master campus map, they select a building, then search for a source and destination room, and the app highlights the optimal route — including which staircase to use and which floor to go to.
